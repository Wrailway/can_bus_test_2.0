...
def test_HAND_GetFirmwareVersion(api):
    ...
    logging.info(f"成功获固件版本: {major[0]}.{minor[0]}.{revision[0]}")
...
def test_HAND_GetHardwareVersion(api):
    ...
    print(f"成功获取硬件版本: {hw_type[0]}.{hw_ver[0]}.{boot_version[0]}")
...
#     err = api.HAND_GetFingerPID(hand_id, finger_id, p, i, d, g, remote_err)
...
#     err = api.HAND_GetFingerCurrentLimit(hand_id, finger_id, current_limit, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetFingerCurrent(hand_id, finger_id, current, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetFingerForceTarget(hand_id, finger_id, force_target, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetFingerForce(hand_id, finger_id, force_entry_cnt, force, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetFingerPosLimit(hand_id, finger_id, low_limit, high_limit, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetFingerPosAbs(hand_id, finger_id, target_pos, current_pos, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetFingerPos(hand_id, finger_id, target_pos, current_pos, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetFingerAngle(hand_id, finger_id, target_angle, current_angle, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetThumbRootPos(hand_id, raw_encoder, pos, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetFingerPosAbsAll(hand_id, target_pos, current_pos, motor_cnt, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetFingerAngleAll(hand_id, target_angle, current_angle, motor_cnt, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetFingerForcePID(hand_id, finger_id, p, i, d, g, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetSelfTestLevel(hand_id, self_test_level, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetBeepSwitch(hand_id, beep_switch, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetButtonPressedCnt(hand_id, pressed_cnt, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetUID(hand_id, uid_w0, uid_w1, uid_w2, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetBatteryVoltage(hand_id, voltage, remote_err)
#     assert err == HAND_RESP_SUCCESS
...
#     err = api.HAND_GetUsageStat(hand_id, total_use_time, total_open_times, motor_cnt, remote_err)
#     assert err == HAND_RESP_SUCCESS
